...
const ManageCourse = () => {
  ...
  const { data: publishedCourses, isLoading } = useGetAllPublishedCourseQuery(currentPage + 1);
  ...
  return (
    <div className="w-full px-4">
      ...
      <div className="w-[95%] mx-auto">
        <CourseTable data={publishedCourses} currentPage={currentPage} setCurrentPage={setCurrentPage} isLoading={isLoading} />
      </div>
    </div>
  );
};
