  ...
  const courseOverview = [
    {
      name: "Active Courses",
      value:
        dashboardData?.data?.courseAnalytics?.courseOverview?.activeCourses ||
        0,
    },
    {
      name: "Draft Courses",
      value:
        dashboardData?.data?.courseAnalytics?.courseOverview?.draftCourses || 0,
    },
    {
      name: "Terminated Courses",
      value:
        dashboardData?.data?.courseAnalytics?.courseOverview
          ?.terminatedCourses || 0,
    },
  ];
  const userGrowth = [
    ...
    >
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          <GenericCard
            value={
              dashboardData?.data?.courseAnalytics?.courseOverview?.totalCourses
            }
            title="Total Courses"
          />
        </Grid>
