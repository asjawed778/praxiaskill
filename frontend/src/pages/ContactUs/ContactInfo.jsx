...
const contactItems = [
  {
    ...
    content: (
      <Box>
        <Typography variant="body2">+9123735554</Typography>
      </Box>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (<Typography variant="body2">
      CAG College Praxia Campus, 5, Pollock Street (Near Tea Board) Kolkata-700001 
    </Typography>),
  },
];
...
const ContactInfo = () => {
  ...
  return (
    ...
    >
      ...
      At our course learning platform, we are dedicated to delivering high-quality, interactive course conten.
      </Typography>
