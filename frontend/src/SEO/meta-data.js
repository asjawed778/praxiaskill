export const defaultMeta = {
    ...
    description: "Join Praxia Skill, a modern tech & digital institute in Kolkata. Learn AI-powered Digital Marketing, Full Stack Web Development & more. Live online & offline.",
    keywords: [
        "online courses",
        "e-learning platform",
        "Praxiaskill",
    ...
    // Optional JSON-LD schema for structured data (can be injected as a script tag)
    schema: {
...
export const allCoursesMeta = {
    title: "Praxiaskill - All Courses",
